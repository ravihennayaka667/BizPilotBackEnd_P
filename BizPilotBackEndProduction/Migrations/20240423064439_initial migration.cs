        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceHeaderInvId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceDetails_InvoiceHeaders_InvoiceHeaderInvId",
                        column: x => x.InvoiceHeaderInvId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_InvoiceHeaderInvId",
                table: "InvoiceDetails",
                column: "InvoiceHeaderInvId");
        }
